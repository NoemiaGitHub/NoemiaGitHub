🔭 Atuo como Técnico de testes, com experiência em criação de cenários de teste, execução de testes manuais, validação de dados e registro de bugs.
🌱 Estou aprendendo automação de testes com Selenium, arquitetura de microserviços e aprimorando minhas habilidades em QA e orientação a objetos.
👯 Aberta a colaboração em projetos open-source e iniciativas de aprendizado em grupo.
📫 Me encontre no LinkedIn: www.linkedin.com/in/noemia-jordania-53a022251

😄 Pronomes: Ela/Dela
⚡ Apaixonada por tecnologia 💻 e pelo aprendizado contínuo, aplicando novos conhecimentos em projetos práticos.
